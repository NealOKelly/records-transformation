...
$wp_customize->add_section( 'section_cta',
	array(
		'title'      => __( 'Call To Action', 'flex-business-pro' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_cta_section]', 
	array(		
	'label' 	=> __('Disable Call to action section', 'flex-business-pro'),
	'section' 	=> 'section_cta',
...
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize,
	...
	'active_callback' => 'flex_business_pro_cta_active',
	'type'        => 'image',
	)
	)
);
...
$wp_customize->add_control('theme_options[cta_small_description]', 
	array(
	'label'       => __('CTA Small Font Description', 'flex-business-pro'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_description]', 
	array(
	'label'       => __('CTA Big Font Description', 'flex-business-pro'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_label]', 
	array(
	'label'       => __('Button Label', 'flex-business-pro'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_url]', 
	array(
	'label'       => __('Button Url', 'flex-business-pro'),
	'section'     => 'section_cta',   
