...
*
* @package flex_business_pro
*/
 jQuery(document).ready(function($) {
    $('#flex-business-pro-img-container li label img').click(function(){    	
        $('#flex-business-pro-img-container li').each(function(){
            $(this).find('img').removeClass ('flex-business-pro-radio-img-selected') ;
        });
        $(this).addClass ('flex-business-pro-radio-img-selected') ;
    });                    
});
