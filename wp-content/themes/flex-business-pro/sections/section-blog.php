...
?>
<?php 
	 $blog_title    = flex_business_pro_get_option( 'blog_title' );
	 $blog_category = flex_business_pro_get_option( 'blog_category' );
	 $blog_number	= flex_business_pro_get_option( 'blog_number' );
		    	...
		    	<div class="post-item">
			      	<?php if(has_post_thumbnail()):?>
				        <div class="featured-image">
				        	<a href="<?php the_permalink();?>"><?php the_post_thumbnail('flex-business-pro-blog');?></a>  
				        </div>
			    	<?php endif?>

			    	<div class="entry-container">
				    	<div class="entry-meta">		         
				            <?php flex_business_pro_posted_on();?>
				        </div><!-- .entry-meta -->
