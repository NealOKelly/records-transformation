...
?>
    <?php 
        $cta_small_description  = flex_business_pro_get_option( 'cta_small_description' );
        $cta_description        = flex_business_pro_get_option( 'cta_description' );
        $cta_button_label       = flex_business_pro_get_option( 'cta_button_label' );
        $cta_button_url         = flex_business_pro_get_option( 'cta_button_url' );
    ?>
