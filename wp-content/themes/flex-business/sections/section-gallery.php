 ...
 */
    $gallery_title       = flex_business_get_option( 'gallery_title' );
    $gy_content_type     = flex_business_get_option( 'gy_content_type' );
    $number_of_gy_column = flex_business_get_option( 'number_of_gy_column' );
    $number_of_gy_items  = flex_business_get_option( 'number_of_gy_items' );
    for( $i=1; $i<=$number_of_gy_items; $i++ ) :
        $gallery_page_posts[] = absint(flex_business_get_option( 'gallery_page_'.$i ) );
    endfor;
    ?>
