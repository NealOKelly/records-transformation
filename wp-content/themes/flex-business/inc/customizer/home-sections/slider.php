...
$wp_customize->add_section( 'section_featured_slider',
	array(
		'title'      => __( 'Featured Slider', 'flex-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_featured_slider]', 
	array(		
	'label' 	=> __('Disable Slider Section', 'flex-business'),
...
$wp_customize->add_control('theme_options[number_of_sr_items]', 
	array(
	'label'       => __('Number Of Slides', 'flex-business'),
	...
	'type'        => 'number',
	'active_callback' => 'flex_business_slider_active',
	'input_attrs' => array(
			'min'	=> 1,
			'max'	=> 3,
			'step'	=> 1,
...
$wp_customize->add_control('theme_options[sr_content_type]', 
	...
	'active_callback' => 'flex_business_slider_active',
	'choices'	  => array(
			'sr_page'	  => __('Page','flex-business'),
		),
	)
);

$number_of_sr_items = flex_business_get_option( 'number_of_sr_items' );
...
for( $i=1; $i<=$number_of_sr_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[slider_page_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'flex_business_slider_page',
		)
	);
}
