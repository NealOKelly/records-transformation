...
$wp_customize->add_section( 'section_cta',
	array(
		'title'      => __( 'Call To Action', 'flex-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_cta_section]', 
	array(		
	'label' 	=> __('Disable Call to action section', 'flex-business'),
	'section' 	=> 'section_cta',
...
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize,
	...
	array(
	'label'       => __('Background Image', 'flex-business'),
	'section'     => 'section_cta',   
	'settings'    => 'theme_options[background_cta_section]',		
	'active_callback' => 'flex_business_cta_active',
	'type'        => 'image',
	)
	)
);
...
$wp_customize->add_control('theme_options[cta_small_description]', 
	array(
	'label'       => __('CTA Small Font Description', 'flex-business'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_description]', 
	array(
	'label'       => __('CTA Big Font Description', 'flex-business'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_label]', 
	array(
	'label'       => __('Button Label', 'flex-business'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_url]', 
	array(
	'label'       => __('Button Url', 'flex-business'),
	'section'     => 'section_cta',   
