...
$wp_customize->add_panel( 'header_top_panel', array(
    'title'          => __( 'Header Top', 'flex-business' ),
    'priority'       => 20,
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'flex-business' ),
...
$wp_customize->add_control(
    'theme_options[show_header_contact_info]',
    array(
        'label'       => __( 'Show Contact Info', 'flex-business' ),
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Location', 'flex-business' ),
        'description'     => __( 'Enter Location.', 'flex-business' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'flex_business_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Phone', 'flex-business' ),
        'description'     => __( 'Enter phone number.', 'flex-business' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'flex_business_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    'theme_options[header_email]',
    array(
        'label'           => __( 'Email', 'flex-business' ),
        'description'     => __( 'Enter valid email address.', 'flex-business' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'flex_business_contact_info_ac',
    )
);
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'flex-business' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'flex-business' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'flex-business' ),
        'description'     => __( 'Enter valid url.', 'flex-business' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'flex_business_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'flex-business' ),
        'description'     => __( 'Enter valid url.', 'flex-business' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'flex_business_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'flex-business' ),
        'description'     => __( 'Enter valid url.', 'flex-business' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'flex_business_social_links_active',
