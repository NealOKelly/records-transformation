...
*/
 jQuery(document).ready(function($) {
    $('#flex-img-container li label img').click(function(){    	
        $('#flex-img-container li').each(function(){
            $(this).find('img').removeClass ('flex-radio-img-selected') ;
        });
        $(this).addClass ('flex-radio-img-selected') ;
    });                    
});
